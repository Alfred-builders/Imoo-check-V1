...
import { Building2, LayoutDashboard, ClipboardList, Users, Settings, LogOut, ChevronUp, ChevronsUpDown } from 'lucide-react'
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-muted text-sm font-semibold">
                    {initials}
                  </div>
